...
/**
 * Game physic processor implementation.
 */
public class GamePhysicProcessorImpl implements GamePhysicProcessor {
    ...
    public void runPhysics() {
        do {
            physicWorld.step(1 / 100f, 5, 5); // XXX magic numbers
        } while (!contactInfoHistory.isFinished());
    }
     ...
     */
    @Override
    public List<ContactInfo> processContactsHistory() {
        final List<ContactInfo> contacts = new ArrayList<ContactInfo>(contactInfoHistory.getContacts());
        doProcessContactHistory();
        return contacts;
    }

    private void doProcessContactHistory() {
    ...
    public void setPhysicWorld(World physicWorld) {
        ...
        physicWorld.setContactListener(new BaseContactListener() {
            ...
            public void preSolve(Contact contact, Manifold oldManifold) {
                GamePhysicProcessorImpl.this.preSolveContact(contact);
            }
        });
    }
